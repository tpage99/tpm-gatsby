          ...
          <div>
            ...
            <div className="grid">
              ...
              <p className="text-block start-text">
                ...
                local businesses within easy reach of people in the Springfield
                area, even if they don't know you yet.
              </p>
            </div>
          </div>
        </Container>
          ...
          <div className="grid">
            ...
            <div className="start-text">
              ...
              <p className="text-block">
                ...
                interaction with customers? Because we do the whole pictures and
                text thing to make your potluck at least look like it's going to
                be really cool.
              </p>
              <Link to="#">
                <button>Learn More</button>
