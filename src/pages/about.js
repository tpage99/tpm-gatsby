  ...
  render() {
    return (
      <div style={{ height: `100%` }}>
        ...
        <main>
          <Container>
            <h1 style={{ textAlign: `center`, paddingTop: `2rem`, fontSize: `3rem` }}>meet your neighbors.</h1>
            ...
            <section style={{ textAlign: `center`, lineHeight: `2.2rem` }}>
              <p style={{ padding: `3rem`, fontSize: `2rem` }}>
              ...
              >
                <p style={{ fontSize: `2rem` }}>
                  We like to help local Springfield Missouri area businesses reach their potential by helping them get
                  in front of their clients. We are all neighbors, after all.
                </p>
              </div>
            </section>
            <section style={{ margin: `2rem`, lineHeight: `2rem` }}>
              <h1 style={{ textAlign: `center`, fontSize: `3rem`, padding: `2rem` }}>why you should work with us.</h1>
            ...
            >
              <p style={{ padding: `1.5rem 3rem`, fontSize: `2rem` }}>
